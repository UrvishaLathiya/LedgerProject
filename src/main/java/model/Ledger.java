...
public class Ledger {
	...
	public Ledger(Long id, String groupName, String subGroupName, Long groupId, Long subGroupId, Timestamp createdDate,
			boolean isActive, boolean isDeleted, Timestamp updatedDate, Integer version, String code, Boolean isGroup,
			Boolean isLedger, Boolean isSubGroup, String ledgerName, Integer createdBy, Integer updatedBy,
			Short ledgerTypeId, Integer parentId, Integer tbMenuId, Integer serialNumber, String formula,
			Boolean isEditable, Integer depreciationLedgerId, Integer accumulatedDepreciationId, boolean isOptional,
			Integer apVersion, Short fsaAreaId, String ledgerHeader) {
		this.id = id;
